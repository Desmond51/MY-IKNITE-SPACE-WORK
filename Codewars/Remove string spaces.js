...
//    Steps
/*
- Create a function to call an our elements.
- Give it a parameter cname x
- Assign it to a new string 
-remove the space from the string using Element.remove()
...
function noSpace(x){
    let newStr = x;
    let final = newStr.remove("");
    console.log(newStr.remove(""));
    return final;
   }
